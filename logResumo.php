...
<title>RNEST - Últimos Dados</title>
</head>
<body>
			...
			<!-- painel -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4>Visualiza&ccedil;&atilde;o de Dados da Qualidade do Ar - &Uacute;ltimos dados</h4>
					</div>
						...
						<?php if($conectadoOk): ?>
							...
							<?php
								...
								while ( $ini < count( $grupoEstacoes ) ){
									...
									$parametroEstacao 	= array_values( $grupoEstacoes );
									exibeTabela( $nomeEstacoes[ $ini ] , null , $parametroEstacao[ $ini ] );
									$ini++;
								}   
